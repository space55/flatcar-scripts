...
src_prepare() {
	local PATCHES=(
		...
		"${FILESDIR}/0021-sysext-Fix-some-small-issues-in-error-cases.patch"
		"${FILESDIR}/0022-sysext-Make-sure-that-merged-hierarchy-does-not-chan.patch"
		"${FILESDIR}/0023-sysext-Check-if-preexisting-mutable-directory-has-a-.patch"
	)
